        ...
        return (
            // <div className='modal__overlay'>
                <div className={`info__modal ${this.state.modalVisible}`}>
                    <h3 className='nopadding'>Welcome to Small Wordle!</h3>
                    <h5 className='nopadding'>In today's fast-moving world, nobody has time for 5 letter word games... With Small Wordle, you get all 
